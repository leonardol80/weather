        ...
        return (
            <article className='show_principal'>
                ...
                <div>
                    ...
                    <div>
                        <h3 className='font_color'>&#34;{weather?.weather[0].description}&#34;</h3>
                        <ul>
                ...
                <h2 className='temperatura'>{isCelsius ? temperature?.celsius : temperature?.farenheit}</h2>
                <button onClick={handleClick}>{isCelsius ? 'Change to oF' : 'Change to oC'}</button>
            </article>
          )
      }
